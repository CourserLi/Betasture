...
namespace again
{
    public partial class Quick : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Quick));
            ...
            this.label9.Location = new System.Drawing.Point(898, 94);
            ...
            this.label9.Text = "快速排序是（Quick sort）是对冒泡排序的一种改进，是非常重要且应用比较广泛的一种高效率排序算法。快速排序是通过多次比较和交换来实现排序，在一趟排序中把将要" +
    "排序的数据分成两个独立的部分，对这两部分进行排序使得其中一部分所有数据比另一部分都要小，然后继续递归排序这两部分，最终实现所有数据有序。";
            // 
            // label8
            // 
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            if (rjButton1.Text == "开始")
            {
                ...
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/quick/quick.m3u8"));
                }
                else
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/quick.mp4"));
                }
                rjButton1.Text = "立即停止";
            }
            else
