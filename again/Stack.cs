...
namespace again
{
    public partial class Stack : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label9.Text = "栈又名堆栈，它是一种运算受限的线性表。限定仅在表尾进行插入和删除操作的线性表。这一端被称为栈顶，相对地，把另一端称为栈底。向一个栈插入新元素又称作进栈、入栈或压栈" +
    "，它是把新元素放到栈顶元素的上面，使之成为新的栈顶元素；从一个栈删除元素又称作出栈或退栈，它是把栈顶元素删除掉，使其相邻的元素成为新的栈顶元素。";
            ...
            this.label8.Location = new System.Drawing.Point(979, 32);
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            if (rjButton1.Text == "开始")
            {
                ...
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/stack/stack.m3u8"));
                }
                else
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/stack.mp4"));
                }
                rjButton1.Text = "立即停止";
            }
            else
