...
namespace again
{
    public partial class Bubble : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label9.Location = new System.Drawing.Point(898, 98);
            ...
            this.label9.Text = "冒泡排序（Bubble Sort），是一种计算机科学领域的较简单的排序算法。它重复地走访过要排序的元素列，依次比较两个相邻的元素，如果顺序（如从大到小、首字母从Z" +
    "到A）错误就把他们交换过来。走访元素的工作是重复地进行，直到没有相邻元素需要交换，也就是说该元素列已经排序完成。";
            // 
            // label8
            // 
            ...
            this.label8.Location = new System.Drawing.Point(935, 32);
            this.label8.Name = "label8";
            this.label8.Size = new System.Drawing.Size(155, 34);
            this.label8.TabIndex = 42;
            this.label8.Text = "冒泡排序";
            // 
            // label7
            // 
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            if (rjButton1.Text == "开始")
            {
                ...
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/bubble/bubble.m3u8"));
                }
                else
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/bubble.mp4"));
                }
                rjButton1.Text = "立即停止";
            }
            else
