...
namespace again
{
    public partial class Merge : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label9.Text = "归并排序是建立在归并操作上的一种有效，稳定的排序算法，该算法是采用分治法（Divide and Conquer）的一个非常典型的应用。将已有序的子序列合并，得到完" +
    "全有序的序列；即先使每个子序列有序，再使子序列段间有序。若将两个有序表合并成一个有序表，称为二路归并。";
            // 
            // label8
            // 
            ...
            this.label8.Location = new System.Drawing.Point(936, 32);
            this.label8.Name = "label8";
            this.label8.Size = new System.Drawing.Size(155, 34);
            this.label8.TabIndex = 42;
            this.label8.Text = "归并排序";
            // 
            // label7
            // 
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            if (rjButton1.Text == "开始")
            {
                ...
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/merge/merge.m3u8"));
                }
                else
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/merge.mp4"));
                }
                rjButton1.Text = "立即停止";
            }
            else
