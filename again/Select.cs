...
namespace again
{
    public partial class Select : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label9.Text = "直接选择排序也是一种简单的排序方法，它的基本思想是：第一次从R[0]~R[n-1]中选取最小值，与R[0]交换，第二次从R[1]~R[n-1]中选取最小值，与R[" +
    "1]交换, ...,第i次从R[i-1]~R[n-1]中选取最小值，与R[i-1]交换, ...,第n-1次从R[n-2]~R[n-1]中选取最小值，与R[n-" +
    "2]交换，总共通过n-1次，得到一个按排序码从小到大排列的有序序列。";
            // 
            // label8
            // 
            ...
            this.label8.Location = new System.Drawing.Point(901, 32);
            this.label8.Name = "label8";
            this.label8.Size = new System.Drawing.Size(225, 34);
            this.label8.TabIndex = 42;
            this.label8.Text = "直接选择排序";
            // 
            // label7
            // 
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            if (rjButton1.Text == "开始")
            {
                ...
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/select/select.m3u8"));
                }
                else
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/select.mp4"));
                }
                rjButton1.Text = "立即停止";
            }
            else
