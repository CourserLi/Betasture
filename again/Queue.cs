...
namespace again
{
    public partial class Queue : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label9.Text = "队列是一种特殊的线性表，特殊之处在于它只允许在表的前端（front）进行删除操作，而在表的后端（rear）进行插入操作，和栈一样，队列是一种操作受限制的线性表。\r" +
    "\n进行插入操作的端称为队尾，进行删除操作的端称为队头。\r\n队列中没有元素时，称为空队列。队列的数据元素又称为队列元素。";
            ...
            this.label8.Location = new System.Drawing.Point(963, 32);
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            if (rjButton1.Text == "开始")
            {
                ...
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/queue/queue.m3u8"));
                }
                else
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/queue.mp4"));
                }
                rjButton1.Text = "立即停止";
            }
            else
