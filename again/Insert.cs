...
namespace again
{
    public partial class Insert : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label9.Text = "直接插入排序是由两层嵌套循环组成的。外层循环标识并决定待比较的数值。内层循环为待比较数值确定其最终位置。直接插入排序是将待比较的数值与它的前一个数值进行比较，所以" +
    "外层循环是从第二个数值开始的。当前一数值比待比较数值大的情况下继续循环比较，直到找到比待比较数值小的并将待比较数值置入其后一位置，结束该次循环。";
            // 
            // label8
            // 
            ...
            this.label8.Location = new System.Drawing.Point(905, 32);
            this.label8.Name = "label8";
            this.label8.Size = new System.Drawing.Size(225, 34);
            this.label8.TabIndex = 42;
            this.label8.Text = "直接插入排序";
            // 
            // label7
            // 
            ...
            this.label7.Location = new System.Drawing.Point(300, 15);
            this.label7.Name = "label7";
            this.label7.Size = new System.Drawing.Size(240, 42);
            this.label7.TabIndex = 41;
            this.label7.Text = "直接插入排序";
            // 
            // label6
            // 
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            if (rjButton1.Text == "开始")
            {
                ...
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/insert/insert.m3u8"));
                }
                else
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/insert.mp4"));
                }
                rjButton1.Text = "立即停止";
            }
            else
