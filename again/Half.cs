...
namespace again
{
    public partial class Half : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Half));
            ...
            this.label9.Location = new System.Drawing.Point(898, 96);
            ...
            this.label9.Text = "折半插入排序（binary insertion sort）是对插入排序算法的一种改进，由于排序算法过程中，就是不断的依次将元素插入前面已排好序的序列中。由于前半部" +
    "分为已排好序的数列，这样我们不用按顺序依次寻找插入点，可以采用折半查找的方法来加快寻找插入点的速度。";
            // 
            // label8
            // 
            ...
            this.label8.Location = new System.Drawing.Point(904, 32);
            this.label8.Name = "label8";
            this.label8.Size = new System.Drawing.Size(225, 34);
            this.label8.TabIndex = 42;
            this.label8.Text = "折半插入排序";
            // 
            // label7
            // 
            ...
            this.label7.Size = new System.Drawing.Size(240, 42);
            this.label7.TabIndex = 41;
            this.label7.Text = "折半插入排序";
            // 
            // label6
            // 
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            if (rjButton1.Text == "开始")
            {
                ...
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/half/half.m3u8"));
                }
                else
                {
                    vlcControl1.Play(new Uri("http://114.115.254.164:8081/half.mp4"));
                }
                rjButton1.Text = "立即停止";
            }
            else
